...
const locationData: Record<string, {
  ...
  'jindabyne': { name: 'Jindabyne', preposition: 'in', relevance: 'Jindabyne\'s mix of year-round homes, holiday properties, and tourism businesses makes this service particularly valuable for the local community.' },
  'thredbo': { name: 'Thredbo', preposition: 'in', relevance: 'Thredbo\'s high-altitude ski lodges, accommodation properties, and extreme alpine conditions require specialist electrical expertise.' },
  'perisher': { name: 'Perisher', preposition: 'in', relevance: 'Perisher resort properties face Australia\'s harshest alpine conditions and need robust, reliable electrical systems.' },
  'charlotte-pass': { name: 'Charlotte Pass', preposition: 'in', relevance: 'Charlotte Pass is Australia\'s highest permanent settlement—electrical systems must withstand extreme alpine conditions.' },
  'berridale': { name: 'Berridale', preposition: 'in', relevance: 'Berridale properties include residential homes, rural properties, accommodation, and tourism businesses serving the region.' },
  'cooma': { name: 'Cooma', preposition: 'in', relevance: 'Cooma is the regional hub with residential, commercial, and rural properties requiring comprehensive electrical services.' },
  'crackenback': { name: 'Crackenback', preposition: 'in', relevance: 'Crackenback\'s alpine holiday homes, resort properties, and luxury accommodation require premium electrical installations.' },
  'kalkite': { name: 'Kalkite', preposition: 'in', relevance: 'Kalkite\'s rural residential properties and holiday homes benefit from reliable electrical systems and modern upgrades.' },
  'dalgety': { name: 'Dalgety', preposition: 'in', relevance: 'Dalgety and Snowy River region properties include farms, rural retreats, and historic homes requiring electrical expertise.' },
  'adaminaby': { name: 'Adaminaby', preposition: 'in', relevance: 'Adaminaby serves Lake Eucumbene properties including fishing shacks, holiday homes, and rural properties.' },
  'east-jindabyne': { name: 'East Jindabyne', preposition: 'in', relevance: 'East Jindabyne\'s growing residential area includes family homes, townhouses, and newer developments.' },
  'guthega': { name: 'Guthega', preposition: 'in', relevance: 'Guthega\'s ski club lodges and alpine properties operate in extreme high-altitude conditions requiring specialist systems.' }
}
            ...
            <div style={{ maxWidth: '800px', margin: '0 auto' }}>
              <div style={{ display: 'grid', gap: 'var(--space-lg)' }}>
                ...
                <div className="service-card">
                  ...
                  <p>
                    Deep understanding of {location.name} properties and the unique electrical challenges
                ...
                <div className="service-card">
                  ...
                  <p>
                    All work completed by NSW licensed electricians. Full compliance certification,
                    insurance, and workmanship guarantees for {location.name} properties.
                  </p>
                </div>
              </div>
            </div>
